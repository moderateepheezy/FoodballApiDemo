...
protocol CollectionViewViewModelConfigurable {
    associatedtype ViewModel
    
    func configure(with viewModel: ViewModel)
}

extension CollectionViewCellRepresentable where CollectionViewCell: CollectionViewViewModelConfigurable & Reusable, CollectionViewCell.ViewModel == Self {
